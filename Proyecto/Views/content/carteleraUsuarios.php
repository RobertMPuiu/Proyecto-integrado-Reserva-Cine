		...
		*/
		...
		?>
					<div class="container-fluid" >
						<div class="row">
							...
							<div class="col-xs-6 col-md-5 col-lg-4 col-xl-4" id="pelicula2">
								<h2 id="tituloPelicula"><?php echo $mostrar[$key]->getTitulo(); ?></h2>

								<span><?php echo $mostrar[$key]->getDuracion() ." min | ".$mostrar[$key]->getPais() ." | ".$mostrar[$key]->getGenero()." | ".$mostrar[$key]->getCalificacion(); ?></span>
								<br>
								<span>Reparto: <?php echo $mostrar[$key]->getReparto(); ?></span>
								<br>
								<span>Director: <?php echo $mostrar[$key]->getDirector(); ?></span>
								<br>
								<span style="display: none;"><?php echo $mostrar[$key]->getSinopsis(); ?></span>
								<br>
								<br>
								<br>
								<br>
								...
								*/
								...
								?>
								<span id="horario"><?php echo $horas[$keyHora]->getHora();  ?></span>
								<?php
										}
									}
								?>
							</div>
							<div class="col-xs-6 col-md-3 col-lg-3 col-xl-2 text-right" id="pelicula3">
								<div class="mt-2">
									 <?php 
									/*
								...
								<form action="realizarReserva.php" method="POST">
									...
									<input type='hidden' name='tituloOculto' id='tituloOculto' class='form-control' value='<?php echo $mostrar[$key]->getTitulo(); ?>'>
									<input type="hidden" name="horas" class="horas" value="<?php echo $horas[0]; ?>">
									<?php } ?>
									...
									<button type="submit" name="reservar" class="reservar" value="<?php echo $mostrar[$key]->getIdPelicula(); ?>">Reservar</button>
								</form>
		...
		<div id="popup-trailer" style="display: none;">
			<div class="content-popup-trailer">
			    ...
			    <div class="container-fluid" id="trailer1">
